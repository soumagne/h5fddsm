...
int_f nh5fd_dsm_init_flags_c(int_f* h5fd_dsm_flags)
{
  ...
  h5fd_dsm_flags[2] = (int_f)H5FD_DSM_UPDATE_LEVEL_0;
  h5fd_dsm_flags[3] = (int_f)H5FD_DSM_UPDATE_LEVEL_1;
  h5fd_dsm_flags[4] = (int_f)H5FD_DSM_UPDATE_LEVEL_2;
  h5fd_dsm_flags[5] = (int_f)H5FD_DSM_UPDATE_LEVEL_3;
  h5fd_dsm_flags[6] = (int_f)H5FD_DSM_UPDATE_LEVEL_4;
